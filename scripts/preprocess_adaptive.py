...
from loader import load_picai_case, pos_list


# Path structure
PROJECT_ROOT = Path(__file__).resolve().parent.parent
DEFAULT_IMAGES_ROOT = PROJECT_ROOT / "inputs" / "images"
DEFAULT_LABELS_ROOT = PROJECT_ROOT / "inputs" / "labels"
DEFAULT_OUTPUT_ROOT = PROJECT_ROOT / "outputs" / "preprocess_v2_adaptive"
